var mainControl = undefined; var imageURL = undefined;
Ext.define("NotesApp.controller.NotesController", {
   ...
   /* activateMainView: function () {
    ...
    onShareCommand: function(){
        ...
        window.plugins.emailComposer.showEmailComposer("Meeting Notes - " + newValues.title, newValues.narrative + '\n\nCreated with BrainStorm!', '','','',false,image);
